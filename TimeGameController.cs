...
public class TimeGameController : MonoBehaviour {
	...
	void CheckIfTheGameIsFinished ()
	{
		...
		//	timer += addToTimer;
			timeInSeconds += countCorrectGuesses;
			timer = timeInSeconds;
			Debug.Log ("You got a total of seconds added " + countCorrectGuesses + " which is added to " + adjustedTimer);
			StartCoroutine(NewRoundBuild ());
			numberOfRounds++;
		//	Debug.Log("adding " + addToTimer + " Seconds to Timer");
			bonusTime.text = "+" + countCorrectGuesses + " SECONDS";
		}
	}
